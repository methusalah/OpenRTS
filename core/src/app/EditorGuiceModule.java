...
class EditorGuiceModule extends AbstractModule {

	private MainEditor main;
	private NiftyJmeDisplay niftyDisplay;
	
	public EditorGuiceModule(MainEditor main, NiftyJmeDisplay niftyDisplay ) {
		this.main = main;
	...
	protected void configure() {
		...
		bind(Nifty.class).toInstance(main.niftyDisplay.getNifty());
