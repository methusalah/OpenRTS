...
public class SoundActor extends Actor {
	...
	public SoundActor(Actor parent, String trigger,	List<String> childrenTriggers,List<ActorBuilder> childrenBuilders,String soundPath,	boolean looping,double volume,boolean positional, ModelManager modelManager) {
